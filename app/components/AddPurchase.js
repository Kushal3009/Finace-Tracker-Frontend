...
import { handlePurchase } from '../services/purchase';
import toast from 'react-hot-toast';
import { useRouter } from 'next/navigation';

const AddPurchase = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const params = {
            ...
            purchaseName: purchaseData.purchaseName,
            date: purchaseData.date,
            price: purchaseData.price,
            paymentType: purchaseData.paymentType
        };
        try {
            const response = await handlePurchase(params);
            ...
            onSubmit(params); // 👈 THIS is what triggers handlePurchaseSubmit in Transactions.js
            ...
            toast(error.message || 'An error occurred while adding the purchase.');
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-gray-900 p-6 rounded-lg w-full max-w-md">
                <h2 className="text-2xl font-bold mb-4 text-white">Add New Purchase</h2>
